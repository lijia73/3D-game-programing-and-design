...
public class SSActionManager : MonoBehaviour, ISSActionCallback
{
	...
	public void SSActionEvent(SSAction source, GameObject arrow = null)
	{
		...
		{
			SceneController scene_controller = SceneController.getInstance();
		}
	}
}
public class ArrowFlyActionManager : SSActionManager
{
	...
	{
		scene_controller = SceneController.getInstance();
		scene_controller.setArrowFlyActionManager(this);
	}
...
public class ArrowFlyAction : SSAction
{
	...
	public override void FixedUpdate()
	{
		...
		if (this.gameobject.transform.position.z > 30 || this.gameobject.tag == "hit")
		{
			this.destroy = true;
